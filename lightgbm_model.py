...
print("Saved: results/lightgbm_results.json")

results_df.to_csv('results/lightgbm_summary.csv', index=False)
print("Saved: results/lightgbm_summary.csv")

with open('results/lightgbm_best_parameters.json', 'w') as f:
    json.dump(best_params, f, indent=4)
print("Saved: results/lightgbm_best_parameters.json")
