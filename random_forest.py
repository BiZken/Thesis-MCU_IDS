...
plt.tight_layout()
plt.savefig('results/random_forest_comparison.png', dpi=300, bbox_inches='tight')
plt.show()
print("Visualization saved to: results/random_forest_comparison.png")
...
print("Saved: results/random_forest_results.json")

results_df.to_csv('results/random_forest_summary.csv', index=False)
print("Saved: results/random_forest_summary.csv")

with open('results/random_forest_best_parameters.json', 'w') as f:
    json.dump(best_params, f, indent=4)
print("Saved: results/random_forest_best_parameters.json")
