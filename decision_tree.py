...
print("Saved: results/decision_tree_results.json")

results_df.to_csv('results/decision_tree_summary.csv', index=False)
print("Saved: results/decision_tree_summary.csv")

with open('results/decision_tree_best_parameters.json', 'w') as f:
    json.dump(best_params, f, indent=4)
print("Saved: results/decision_tree_best_parameters.json")
