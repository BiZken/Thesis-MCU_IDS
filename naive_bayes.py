...
param_grids['Naive_Bayes'] = {
    'var_smoothing': np.logspace(-12, -1, 2000),
}
...
plt.tight_layout()
plt.savefig('results/naive_bayes_comparison.png', dpi=300, bbox_inches='tight')
plt.show()
print("Visualization saved to: results/naive_bayes_comparison.png")
...
with open('results/naive_bayes_results.json', 'w') as f:
    json.dump(results, f, indent=4)
print("Saved: results/naive_bayes_results.json")

results_df.to_csv('results/naive_bayes_summary.csv', index=False)
print("Saved: results/naive_bayes_summary.csv")

with open('results/naive_bayes_best_parameters.json', 'w') as f:
    json.dump(best_params, f, indent=4)
print("Saved: results/naive_bayes_best_parameters.json")
