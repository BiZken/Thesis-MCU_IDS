...
models['Extra_Trees'] = ExtraTreesClassifier(random_state=RANDOM_STATE, n_jobs=-1)
...
with open('results/extra_trees_results.json', 'w') as f:
    json.dump(results, f, indent=4)
print("Saved: results/extra_trees_results.json")

results_df.to_csv('results/extra_trees_summary.csv', index=False)
print("Saved: results/extra_trees_summary.csv")

with open('results/extra_trees_best_parameters.json', 'w') as f:
    json.dump(best_params, f, indent=4)
print("Saved: results/extra_trees_best_parameters.json")
